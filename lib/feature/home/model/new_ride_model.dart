class NewRideModel {
  ...
  String? bookingId;
  Passenger? passenger;
  NewRideModelTripDetails? tripDetails;
  int? acceptanceTimer;
  Booking? booking;
  Fare? fare;
  Invoice? invoice;
  NewRideModelCustomer? customer;
  Dropoff? pickup;
  Dropoff? dropoff;
  ...
  factory NewRideModel.fromJson(Map<String, dynamic> json) => NewRideModel(
    ...
    tripDetails: json["trip_details"] == null
        ? null
        : NewRideModelTripDetails.fromJson(json["trip_details"]),
    ...
    customer: json["customer"] == null
        ? null
        : NewRideModelCustomer.fromJson(json["customer"]),
    ...
    driverEtaMinutes: json["driver_eta_minutes"] is num
        ? (json["driver_eta_minutes"] as num).toInt()
        : int.tryParse(json["driver_eta_minutes"]?.toString() ?? ''),
...
class Booking {
  ...
  Booking copyWith({
    ...
    return Booking(
      ...
      cancelCharge: cancelCharge ?? this.cancelCharge,
    );
  }
...
class NewRideModelCustomer {
  ...
  factory NewRideModelCustomer.fromJson(Map<String, dynamic> json) =>
      NewRideModelCustomer(
...
class Driver {
  ...
  Driver({this.name, this.phone, this.vehicle, this.licensePlate});
...
class NewRideModelTripDetails {
  String? distance;
  String? fare;
  String? duration;

  NewRideModelTripDetails({this.distance, this.fare, this.duration});

  NewRideModelTripDetails copyWith({
    String? distance,
    String? fare,
    String? duration,
  }) => NewRideModelTripDetails(
    distance: distance ?? this.distance,
    fare: fare ?? this.fare,
    duration: duration ?? this.duration,
  );

  factory NewRideModelTripDetails.fromJson(Map<String, dynamic> json) =>
      NewRideModelTripDetails(
        distance: json["distance"],
        fare: json["fare"],
        duration: json["duration"],
