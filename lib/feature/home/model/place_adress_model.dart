class AddressPlaceModel {
  ...
  AddressPlaceModel({this.predictions, this.status});

  AddressPlaceModel copyWith({List<Prediction>? predictions, String? status}) =>
      AddressPlaceModel(
...
class Term {
  ...
  Term copyWith({int? offset, String? value}) =>
      Term(offset: offset ?? this.offset, value: value ?? this.value);
