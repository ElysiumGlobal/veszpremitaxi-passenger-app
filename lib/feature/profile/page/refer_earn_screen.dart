...
class _ReferEarnScreenState extends State<ReferEarnScreen> {
  final profileControler = Get.find<ProfileController>();
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CommonText(
                string:
                    "Refer your friends & earn ${Utils.formatCurrency("5")}!",
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      CommonText(
                        string:
                            "${profileControler.userModel.value?.referralCode}",
                      ),
                      GestureDetector(
                        onTap: () {
                          Clipboard.setData(
              ...
              CustomButton(
                onTap: () {
                  ...
                  SharePlus.instance.share(
                    ShareParams(
                      text:
                          "${AppConstant().appName}, Referral Code : ${profileControler.userModel.value?.referralCode ?? ""}\n\n$link",
                      sharePositionOrigin:
